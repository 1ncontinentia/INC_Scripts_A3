...
if (_percentage > 30) then {
    if ((_percentage > (random 100)) && (_undercoverUnit getVariable ["isUndercover", false])) then {
        ...
        if (_undercoverGroup < (5 + (ceil random 5))) then {
            ...
            private _civComment = selectRandom ["I've heard about you.","You can count on me.","I admire what you're doing.","You have my support.","Thank you for helping rid us of this scourge.","Thank you for helping our people.","I don't want them to see my face."];
            [[_civ, _civComment] remoteExec ["globalChat",0]];

            [_civ,_undercoverUnit] remoteExecCall ["INCON_fnc_recruitSuccess",2];

        } else {
            private _civComment = selectRandom ["Keep up the good work guys.","You all just keep doing what you're doing.","You don't need me, I'll just hold you guys back.","You'll all be fine without me."];
            [[_civ, _civComment] remoteExec ["globalChat",0]];
        };

    } else {

        private _civComment = selectRandom ["I am just a simple farmer's wife.","I like your style but I've got kids to feed.","Sorry, I'm too drunk.","You get those fuckers.","Get me some more raksi and I'll think about it.","My wife would kill me.","My foot hurts too much but I appreciate what you're doing.","You're a good man but I can't I'm afraid.","Man, I wish I could."];
        [[_civ, _civComment] remoteExec ["globalChat",0]];
    ...
    if ((_percentage > (random 100)) && (_undercoverUnit getVariable ["isUndercover", false]) && !(_undercoverUnit getVariable ["INC_undercoverCompromised", false])) then {
        ...
        if (_undercoverGroup < (2 + (random 5))) then {
            ...
            private _civComment = selectRandom ["This is for Cyril.","I'll get my fighting hat on.","I'm bored, why not.","I'll join you, but only because they ran over my pet rabbit Steve.","I should really know better.","I'm going to regret this.","Fuck it, let's go.","My wife is going to kill me for this.","Well it's better than gardening."];
            [[_civ, _civComment] remoteExec ["globalChat",0]];
            ...
            private _civComment = selectRandom ["Don't you have enough already?","I haven't heard of you guys before. I'm out.","Prove yourselves and maybe I'll join you next time.","Who are you guys?","I don't like the look of you lot."];
            [[_civ, _civComment] remoteExec ["globalChat",0]];
