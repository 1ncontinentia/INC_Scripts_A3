...
_saveType = "loop"                  //Can be "loop" or "onExit" - loop will save the player's group data every 60 seconds throughout the mission, "onExit" will save the player's group on player disconnect
