			...
			_unit addEventHandler["Killed", {
				...
				[-1, {
					readData = _this addAction ["<t color='#FF0000'>Upload device data for SIGINT analysis</t>",{
						...
						[[asymIntelSide,40,80], "INCON\INC_intel\Scripts\unitTracker.sqf"] remoteExec ["execVM",_gatherer]; //Change this to whatever you want to happen when action is used
						_intel removeAction readData;
						deleteVehicle _intel;
			...
			_unit addEventHandler["Killed", {
				...
				[-1, {
					readData = _this addAction ["<t color='#FF0000'>Upload device data for SIGINT analysis</t>",{
						...
						_intel = _this select 0;
						_gatherer = _this select 1;
						[[asymIntelSide], "INCON\INC_intel\Scripts\unitTrackerPhone.sqf"] remoteExec ["execVM",_gatherer]; //Change this to whatever you want to happen when action is used
						_intel removeAction readData;
						deleteVehicle _intel;
		...
		_unit addEventHandler["Killed", {
			...
			[-1, {
				readData = _this addAction ["<t color='#FF0000'>Upload device data for SIGINT analysis</t>",{
					...
					[[convIntelSide,40,80], "INCON\INC_intel\Scripts\unitTracker.sqf"] remoteExec ["execVM",_gatherer]; //Change this to whatever you want to happen when action is used
					_intel removeAction readData;
					deleteVehicle _intel;
		...
		_unit addEventHandler["Killed", {
			...
			[-1, {
				readData = _this addAction ["<t color='#FF0000'>Upload device data for SIGINT analysis</t>",{
					...
					_intel = _this select 0;
					_gatherer = _this select 1;
					[[convIntelSide], "INCON\INC_intel\Scripts\unitTrackerPhone.sqf"] remoteExec ["execVM",_gatherer]; //Change this to whatever you want to happen when action is used
					_intel removeAction readData;
					deleteVehicle _intel;
